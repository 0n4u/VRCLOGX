...
def find_defined_levels(): # -> dict[Any, Any]:
    """
...
def level_to_number(value): # -> Literal[20]:
    """
...
def find_level_aliases(): # -> dict[Any, Any]:
    """
...
def parse_encoded_styles(text, normalize_key=...): # -> dict[Any, Any]:
    """
...
def find_hostname(use_chroot=...): # -> str:
    """
...
def replace_handler(logger, match_handler, reconfigure): # -> tuple[Any | None, Logger | Any]:
    """
...
def find_handler(logger, match_handler): # -> tuple[Any, Logger] | tuple[None, None]:
    """
...
def match_stream_handler(handler, streams=...): # -> bool:
    """
...
def walk_propagation_tree(logger): # -> Generator[Logger, Any, None]:
    """
...
class ColoredFormatter(BasicFormatter):
    ...
    """
    def __init__(self, fmt=..., datefmt=..., style=..., level_styles=..., field_styles=...) -> None:
        """
    ...
    def colorize_format(self, fmt, style=...): # -> LiteralString:
        """
...
class HostNameFilter(logging.Filter):
    ...
    """
    @classmethod
    def install(cls, handler, fmt=..., use_chroot=..., style=...): # -> None:
        """
    ...
    def __init__(self, use_chroot=...) -> None:
        """
...
class ProgramNameFilter(logging.Filter):
    ...
    """
    @classmethod
    def install(cls, handler, fmt, programname=..., style=...): # -> None:
        """
...
class UserNameFilter(logging.Filter):
    ...
    """
    @classmethod
    def install(cls, handler, fmt, username=..., style=...): # -> None:
        """
...
class FormatStringParser:
    ...
    def contains_field(self, format_string, field_name): # -> bool:
        """
    ...
    def get_field_names(self, format_string): # -> list[Any]:
        """
        Get the field names referenced by a format string.
    ...
    def get_grouped_pairs(self, format_string): # -> list[Any]:
        """
    ...
    def get_pairs(self, format_string): # -> Generator[FormatStringToken, Any, None]:
        """
    ...
    def get_pattern(self, field_name): # -> Pattern[str]:
        """
    ...
    def get_tokens(self, format_string): # -> list[str | Any]:
        """
...
class NameNormalizer:
    ...
    def normalize_keys(self, value): # -> dict[Any, Any]:
        """
